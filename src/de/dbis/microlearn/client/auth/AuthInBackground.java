 ...
 */
public class AuthInBackground extends AbstractAuthTask {

  public AuthInBackground(GoogleLoginActivity activity, String email, String scope, int requestCode) {
...
//           Log.i(TAG, token);
//           mActivity.show("Token: " + token.substring(0, 15));
           return token;
  ...
  private Intent makeCallback(String accountName) {
      ...
      intent.setAction("de.dbis.microlearn.client.auth.google.Callback");
      intent.putExtra(GoogleLoginActivity.EXTRA_ACCOUNTNAME, accountName);
      return intent;
  }
