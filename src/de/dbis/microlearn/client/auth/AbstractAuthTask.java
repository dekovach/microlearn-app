...
public abstract class AbstractAuthTask extends AsyncTask<Void, Void, Void>{
    protected static final String TAG = "TokenInfoTask";
    ...
    AbstractAuthTask(GoogleLoginActivity activity, String email, String scope, int requestCode) {
...
//    	  fetchToken();
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          String name = getFullName(readResponse(is));
//          mActivity.show("Hello " + name + "!");
          Message msg = new Message();
          msg.what = GoogleLoginActivity.USERNAME;
          Bundle data = new Bundle();
          data.putString("user_name", name);
          data.putString("token", token);
          msg.setData(data);
          mActivity.mIncomingHandler.sendMessage(msg);
          is.close();
          return;
        } else if (sc == 401) {
    ...
    private String getFullName(String jsonResponse) throws JSONException {
    	JSONObject profile = new JSONObject(jsonResponse);
    	return profile.getString(FULL_NAME_KEY);
    }
}
